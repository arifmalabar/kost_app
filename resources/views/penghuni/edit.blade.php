                            ...
                            <div class="bs-stepper">
                                <div class="bs-stepper-header" role="tablist">
                                    ...
                                    <div class="step" data-target="#ktp-part">
                                        <button type="button" class="step-trigger" role="tab" aria-controls="ktp-part"
                                            id="ktp-part-trigger">
                                ...
                                <div class="bs-stepper-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <textarea class="form-control alamat_kampus" name="alamat_kampus" id="" cols="15" rows="4"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <textarea class="form-control alamat_rumah" name="alamat_rumah" id="" cols="15" rows="4"
                                                            placeholder="Masukan Alamat"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <button class="btn btn-success" onclick="stepper.next()"
                                    ...
                                    <div id="ktp-part" class="content" role="tabpanel"
                                        aria-labelledby="ktp-part-trigger">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="">Foto KTP Saat Ini</label>
                                            </div>
                                            <div class="col-md-12">
                                                <img class="foto-ktp" src="" height="300px" width="500px"
                                                    alt="foto ktp">
                                            </div>
                                            <div class="col-md-12" style="margin-top: 20px">
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-4 col-form-label">Upload KTP
                                                        Baru</label>
                                                    <div class="col-sm-8">
                                            ...
                                            <div class="col-md-6">
                                                <button class="btn btn-success text-white" onclick="stepper.next()"
                                    ...
                                    <div id="information-part" class="content" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col-md-11">
                                                <div class="form-group row">
                                                    <label for="inputEmail3"
                                                        class="col-sm-4 col-form-label">Gedung</label>
                                                    <div class="col-sm-8">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <label for="" class="old-ruang">Ruangan Sebelumnya :
                                                        </label>
                                                    </div>
                                                    <div class="col-md-6">
...
@section('jscript')
    <script>
        ...
        function convertToRupiah(element) {
            let value = element.value.replace(/[^0-9]/g, "");
            element.value = value ? value.replace(/\B(?=(\d{3})+(?!\d))/g, ".") : "";
        }
