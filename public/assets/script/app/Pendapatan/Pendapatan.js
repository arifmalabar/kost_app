...
export default function showBarChart()
{
    ...
    //--------------
    $.ajax({
        url: 'grafik_pendapatan',
        method: 'GET',
        success: function (response){
            const pendapatanSeharusnya = response.pendapatanSeharusnya;
            const pendapatan = response.pendapatan;

            var data_chart = {
                labels: ['January', 'February', 'Mach', 'April', 'May', 'June', 'July', 'Aug', 'Sept', 'Oct', 'Nop', 'Dec'],
                datasets: [{
